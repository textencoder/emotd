...
export default function IconLogo() {
  return (
    ...
    >
      ...
      <path d="M9.5 18h5" className={styles.tower} />
      <path d="m8 22 4-11 4 11" className={styles.tower} />
    </svg>
  );
}
